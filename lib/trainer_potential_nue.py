...
class TrainerPotential(object):
    ...
    def loss_allK(self, support_sets, generator, reconstructor,
        ...
        img1_for_cls = img1.detach() if detach_img1 else img1

        logits, magnitudes = reconstructor(img1_for_cls, img2)   # [B*K, K]
        logits0, magnitudes0 = reconstructor(img0, img1_for_cls)
