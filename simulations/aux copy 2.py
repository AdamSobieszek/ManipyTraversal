...
class ImageViz:
    ...
    def compute_pairwise_avg_and_wasserstein(
        ...
        *,
        ...
        reg: float = 5e-2,               # sinkhorn regularization
        ...
        z = z_bkd.detach().to(device="cpu", dtype=torch.float32).numpy()  # [B,K,D]
...
def tb_path_figs(writer, step: int, *, support_sets, z_first: torch.Tensor, dt_first: torch.Tensor):
    """
